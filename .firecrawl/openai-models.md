...
New\\
\\
Best intelligence at scale for agentic, coding, and professional workflows](https://developers.openai.com/api/docs/models/gpt-5.4)

[Model ID\\
\\
gpt-5.4](https://developers.openai.com/api/docs/models/gpt-5.4)

[Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning)
...
New\\
\\
Our strongest mini model yet for coding, computer use, and subagents](https://developers.openai.com/api/docs/models/gpt-5.4-mini)
...
New\\
\\
Our cheapest GPT-5.4-class model for simple high-volume tasks](https://developers.openai.com/api/docs/models/gpt-5.4-nano)
...
[![gpt-image-1.5](https://developers.openai.com/images/api/models/icons/gpt-image-1.5.png)\\
\\
GPT Image 1.5\\
\\
State-of-the-art image generation model](https://developers.openai.com/api/docs/models/gpt-image-1.5) [![gpt-image-1-mini](https://developers.openai.com/images/api/models/icons/gpt-image-1-mini.png)\\
\\
gpt-image-1-mini\\
\\
A cost-efficient version of GPT Image 1](https://developers.openai.com/api/docs/models/gpt-image-1-mini)

Video

Models for video generation

[![sora-2](https://developers.openai.com/images/api/models/icons/sora-2.png)\\
\\
Sora 2\\
\\
Flagship video generation with synced audio](https://developers.openai.com/api/docs/models/sora-2) [![sora-2-pro](https://developers.openai.com/images/api/models/icons/sora-2-pro.png)\\
\\
Sora 2 Pro\\
\\
Most advanced synced-audio video generation](https://developers.openai.com/api/docs/models/sora-2-pro)

Realtime

Models for realtime speech-to-speech

[![gpt-realtime-1.5](https://developers.openai.com/images/api/models/icons/gpt-realtime-1.5.png)\\
\\
gpt-realtime-1.5\\
\\
The best voice model for audio in, audio out](https://developers.openai.com/api/docs/models/gpt-realtime-1.5) [![gpt-realtime-mini](https://developers.openai.com/images/api/models/icons/gpt-realtime-mini.png)\\
\\
gpt-realtime-mini\\
\\
A cost-efficient version of GPT Realtime](https://developers.openai.com/api/docs/models/gpt-realtime-mini)

Speech generation

Models for generating natural-sounding speech from text

[![gpt-4o-mini-tts](https://developers.openai.com/images/api/models/icons/gpt-4o-mini-tts.png)\\
\\
GPT-4o mini TTS\\
\\
Text-to-speech model powered by GPT-4o mini](https://developers.openai.com/api/docs/models/gpt-4o-mini-tts)

Transcription

Models for transcribing speech into text

[![gpt-4o-transcribe](https://developers.openai.com/images/api/models/icons/gpt-4o-transcribe.png)\\
\\
GPT-4o Transcribe\\
\\
Speech-to-text model powered by GPT-4o](https://developers.openai.com/api/docs/models/gpt-4o-transcribe) [![gpt-4o-mini-transcribe](https://developers.openai.com/images/api/models/icons/gpt-4o-mini-transcribe.png)\\
\\
GPT-4o mini Transcribe\\
\\
Speech-to-text model powered by GPT-4o mini](https://developers.openai.com/api/docs/models/gpt-4o-mini-transcribe)
...
[How we use your data](https://developers.openai.com/api/docs/guides/your-data)· [Deprecated models](https://developers.openai.com/api/docs/deprecations)