...
class WindowsTrayService implements PlatformTrayService {
  ...
  Future<void> init({
    ...
    if (!Platform.isWindows) {
      throw UnsupportedError('WindowsTrayService can only be used on Windows');
    }

    _onMenuItemClick = onMenuItemClick;

    // 初始化 tray_manager
    await trayManager.setIcon(iconPath ?? 'assets/icons/app_icon.ico');
  ...
  Future<void> showWindow() async {
    ...
    try {
      ...
      print('WindowsTrayService: 显示窗口失败: $e');
    }
  }
  ...
  Future<void> hideWindow() async {
    ...
    try {
      ...
      print('WindowsTrayService: 隐藏窗口失败: $e');
    }
  }
