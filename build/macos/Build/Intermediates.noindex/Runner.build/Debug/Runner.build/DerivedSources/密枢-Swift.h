...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="密枢",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_PROTOCOL("_TtP6密枢19AppDelegateProtocol_")
@protocol AppDelegateProtocol
- (void)checkAndSetupStatusBar;
@end

@class NSNotification;
@class NSMenuItem;
@class NSApplication;
SWIFT_CLASS("_TtC6密枢11AppDelegate")
@interface AppDelegate : FlutterAppDelegate <AppDelegateProtocol>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)notification;
- (void)checkAndSetupStatusBar;
- (void)statusBarButtonClicked;
- (void)showWindow;
- (void)quitApplication;
- (void)switchClaudeCodeKey:(NSMenuItem * _Nonnull)sender;
- (void)switchCodexKey:(NSMenuItem * _Nonnull)sender;
- (void)switchGeminiKey:(NSMenuItem * _Nonnull)sender;
...
SWIFT_CLASS("_TtC6密枢17MainFlutterWindow")
...
SWIFT_CLASS("_TtC6密枢14WindowDelegate")
